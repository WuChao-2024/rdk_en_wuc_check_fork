...
| 类型 | 供应商 | 型号 | 描述 | 购买链接 |
| --- | --------- | -------- | --------------- | --------- |
| Audio interface board | Waveshare | Audio Driver HAT | Supports 4-MIC circular recording, dual-channel playback, and audio resampling | [Purchase link](https://www.waveshare.net/shop/Audio-Driver-HAT.htm) |
| Audio interface board | Waveshare | WM8960 Audio HAT | Supports dual-channel recording and playback, compatible with RDK X3 2.0 and RDK X3 Module | [Purchase link](https://www.waveshare.net/shop/WM8960-Audio-HAT.htm) |